...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LALT(KC_TAB), _______, _______, KC_LBRC, KC_RBRC, RSFT(BSLASH), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,
    ...
    _______, _______, _______, KC_LCBR, KC_RCBR, BSLASH, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLASH,  _______,
