...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______, _______, _______, KC_LCTL, MO(1), KC_ENT, KC_LGUI,  KC_LALT, _______, KC_0,    KC_0,    KC_DOT,  KC_ENT,  KC_SPC, MO(1), KC_RCTRL, _______, _______, _______),

    [1] = KEYMAP(
    KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, _______, LGUI(KC_L), _______, _______, _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_DEL,
    LALT(KC_TAB), _______, _______, KC_LBRC, KC_RBRC, RSFT(KC_BSLASH), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PLUS,  _______,
    ...
    _______, _______, _______, KC_LCBR, KC_RCBR, KC_BSLASH, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_BSLASH,  _______,
