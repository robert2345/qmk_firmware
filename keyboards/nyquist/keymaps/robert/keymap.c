...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
            RESET,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_SLSH,  KC_PAST,  KC_PMNS,         KC_DEL,
            _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_7,     KC_8,     KC_9,     KC_PLUS,         _______,
            _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_4,     KC_5,     KC_6,     LSFT(KC_SCLN),  KC_EQUAL,
